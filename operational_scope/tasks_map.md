...
| Выделение `Backend service` в отдельный repository | done | [`operational_scope/tasks/053-backend-service-repo-extraction.md`](operational_scope/tasks/053-backend-service-repo-extraction.md:1) |
