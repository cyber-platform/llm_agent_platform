...
from api.openai.providers.base import Provider
from api.openai.types import ChatRequestContext
from api.openai.response_shaper import shape_gemini_nonstream_response
from api.openai.streaming import gemini_chunk_to_sse_events, build_usage_stream_chunk, parse_vertex_stream_line
from config import STRICT_CLI_PARITY
...
class DirectStrategy:
    ...
    def stream(self, ctx: ChatRequestContext, provider: Provider):
        ...
        try:
            ...
            from services.quota_transport import parse_stream_exception
