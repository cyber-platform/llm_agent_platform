...
| Backend admin JWT guard через `user_service` shared-secret baseline | completed | [`operational_scope/tasks/056-backend-admin-jwt-guard-via-user-service.md`](operational_scope/tasks/056-backend-admin-jwt-guard-via-user-service.md:1) |
