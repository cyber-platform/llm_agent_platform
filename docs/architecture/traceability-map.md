...
| Public machine-auth for `openai-chatgpt` | OpenAI auth guard, API key registry, route resolver | [`llm_agent_platform/api/openai/auth_guard.py`](llm_agent_platform/api/openai/auth_guard.py:1), [`llm_agent_platform/services/openai_chatgpt_api_keys.py`](llm_agent_platform/services/openai_chatgpt_api_keys.py:1), [`llm_agent_platform/api/openai/routes.py`](llm_agent_platform/api/openai/routes.py:1) | [`docs/providers/openai-chatgpt.md`](docs/providers/openai-chatgpt.md:1), [`docs/contracts/api/openai/errors/401-invalid-api-key-error.schema.json`](docs/contracts/api/openai/errors/401-invalid-api-key-error.schema.json:1) | [`llm_agent_platform/tests/test_openai_chatgpt_runtime.py`](llm_agent_platform/tests/test_openai_chatgpt_runtime.py:1), [`llm_agent_platform/tests/test_refactor_p2_routes.py`](llm_agent_platform/tests/test_refactor_p2_routes.py:1) |
| Provider-scoped admin API key registry | Admin routes, API key registry service | [`llm_agent_platform/api/admin/routes.py`](llm_agent_platform/api/admin/routes.py:1), [`llm_agent_platform/services/openai_chatgpt_api_keys.py`](llm_agent_platform/services/openai_chatgpt_api_keys.py:1) | [`docs/architecture/admin-monitoring-read-model.md`](docs/architecture/admin-monitoring-read-model.md:1), [`docs/contracts/api/admin/api-keys/`](docs/contracts/api/admin/api-keys:1), [`docs/providers/openai-chatgpt.md`](docs/providers/openai-chatgpt.md:1) | [`llm_agent_platform/tests/test_admin_api_keys.py`](llm_agent_platform/tests/test_admin_api_keys.py:1), [`docs/testing/suites/admin-api-keys.md`](docs/testing/suites/admin-api-keys.md:1) |
...
| Admin monitoring boundary | Monitoring runtime store, admin routes, `LLM provider`-specific monitoring contracts | [`llm_agent_platform/services/openai_chatgpt_admin_monitoring.py`](llm_agent_platform/services/openai_chatgpt_admin_monitoring.py:1), [`llm_agent_platform/api/admin/routes.py`](llm_agent_platform/api/admin/routes.py:1) | [`docs/architecture/admin-monitoring-read-model.md`](docs/architecture/admin-monitoring-read-model.md:1), [`docs/architecture/admin-monitoring-refresh-subsystem.md`](docs/architecture/admin-monitoring-refresh-subsystem.md:1), [`docs/architecture/platform-monitoring-runtime.md`](docs/architecture/platform-monitoring-runtime.md:1), [`docs/adr/0021-account-centric-provider-monitoring-and-admin-read-model.md`](docs/adr/0021-account-centric-provider-monitoring-and-admin-read-model.md:1) | [`llm_agent_platform/tests/test_admin_monitoring_read_model.py`](llm_agent_platform/tests/test_admin_monitoring_read_model.py:1), [`llm_agent_platform/tests/test_admin_monitoring_refresh.py`](llm_agent_platform/tests/test_admin_monitoring_refresh.py:1), [`docs/testing/suites/admin-monitoring-read-model.md`](docs/testing/suites/admin-monitoring-read-model.md:1), [`docs/testing/suites/admin-monitoring-refresh.md`](docs/testing/suites/admin-monitoring-refresh.md:1) |
| Operator Web UI PoC delivery boundary | Local-only frontend service, reverse proxy config, runtime config | [`services/frontend/`](services/frontend:1), [`services/frontend/config/dev-server.json`](services/frontend/config/dev-server.json:1), [`docker-compose.yml`](docker-compose.yml:1) | [`docs/architecture/web-ui.md`](docs/architecture/web-ui.md:1), [`docs/adr/0024-poc-operator-frontend-delivery-boundary.md`](docs/adr/0024-poc-operator-frontend-delivery-boundary.md:1), [`docs/testing/suites/openai-chatgpt-poc-smoke.md`](docs/testing/suites/openai-chatgpt-poc-smoke.md:1) | `npm run build` in `services/frontend`, [`llm_agent_platform/tests/test_openai_chatgpt_poc_smoke.py`](llm_agent_platform/tests/test_openai_chatgpt_poc_smoke.py:1) |
