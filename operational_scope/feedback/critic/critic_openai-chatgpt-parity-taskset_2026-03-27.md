...
- Target task set: [`operational_scope/tasks/034-openai-chatgpt-tool-and-streaming-parity.md`](operational_scope/tasks/034-openai-chatgpt-tool-and-streaming-parity.md:1), [`operational_scope/tasks/035-openai-chatgpt-auth-invalid-state.md`](operational_scope/tasks/035-openai-chatgpt-auth-invalid-state.md:1), [`operational_scope/tasks/036-account-router-auth-invalid-exclusion.md`](operational_scope/tasks/036-account-router-auth-invalid-exclusion.md:1), [`operational_scope/tasks/037-openai-chatgpt-parity-regression-and-doc-sync.md`](operational_scope/tasks/037-openai-chatgpt-parity-regression-and-doc-sync.md:1)
...
- Evidence / references: [`plans/openai-chatgpt-parity-audit-plan.md`](plans/openai-chatgpt-parity-audit-plan.md:188), [`plans/openai-chatgpt-parity-audit-plan.md`](plans/openai-chatgpt-parity-audit-plan.md:250), [`docs/contracts/state/account-state.schema.json`](docs/contracts/state/account-state.schema.json:1), [`operational_scope/tasks/035-openai-chatgpt-auth-invalid-state.md`](operational_scope/tasks/035-openai-chatgpt-auth-invalid-state.md:25)
- Proposed fix:
...
- Traceability:
  - Tasks to update / create: [`operational_scope/tasks/035-openai-chatgpt-auth-invalid-state.md`](operational_scope/tasks/035-openai-chatgpt-auth-invalid-state.md:1), [`operational_scope/tasks/037-openai-chatgpt-parity-regression-and-doc-sync.md`](operational_scope/tasks/037-openai-chatgpt-parity-regression-and-doc-sync.md:1)
...
- Traceability:
  - Tasks to update / create: [`operational_scope/tasks/035-openai-chatgpt-auth-invalid-state.md`](operational_scope/tasks/035-openai-chatgpt-auth-invalid-state.md:1), [`operational_scope/tasks/036-account-router-auth-invalid-exclusion.md`](operational_scope/tasks/036-account-router-auth-invalid-exclusion.md:1)
...
- Evidence / references: [`plans/openai-chatgpt-parity-audit-plan.md`](plans/openai-chatgpt-parity-audit-plan.md:221), [`docs/architecture/quota-group-state-snapshot-and-state-dir.md`](docs/architecture/quota-group-state-snapshot-and-state-dir.md:144), [`docs/testing/suites/quota-state-persistence.md`](docs/testing/suites/quota-state-persistence.md:32), [`operational_scope/tasks/036-account-router-auth-invalid-exclusion.md`](operational_scope/tasks/036-account-router-auth-invalid-exclusion.md:22)
- Proposed fix:
...
- Severity: `high`
- Problem: план и задача [`operational_scope/tasks/036-account-router-auth-invalid-exclusion.md`](operational_scope/tasks/036-account-router-auth-invalid-exclusion.md:22) вводят новый terminal state `all accounts auth-invalid`, но не определяют HTTP status, `error.type`, `error.message` и различие между `single` и `rounding` path. Это уже внешний observable behavior OpenAI-compatible surface.
...
- Evidence / references: [`plans/openai-chatgpt-parity-audit-plan.md`](plans/openai-chatgpt-parity-audit-plan.md:228), [`plans/openai-chatgpt-parity-audit-plan.md`](plans/openai-chatgpt-parity-audit-plan.md:235), [`operational_scope/tasks/036-account-router-auth-invalid-exclusion.md`](operational_scope/tasks/036-account-router-auth-invalid-exclusion.md:23), [`docs/contracts/api/openai/errors/429-error.schema.json`](docs/contracts/api/openai/errors/429-error.schema.json:1), [`docs/testing/suites/quota-account-rotation.md`](docs/testing/suites/quota-account-rotation.md:29)
- Proposed fix:
...
- Traceability:
  - Tasks to update / create: [`operational_scope/tasks/036-account-router-auth-invalid-exclusion.md`](operational_scope/tasks/036-account-router-auth-invalid-exclusion.md:1), [`operational_scope/tasks/037-openai-chatgpt-parity-regression-and-doc-sync.md`](operational_scope/tasks/037-openai-chatgpt-parity-regression-and-doc-sync.md:1)
...
- Evidence / references: [`plans/openai-chatgpt-parity-audit-plan.md`](plans/openai-chatgpt-parity-audit-plan.md:239), [`operational_scope/tasks/035-openai-chatgpt-auth-invalid-state.md`](operational_scope/tasks/035-openai-chatgpt-auth-invalid-state.md:29), [`operational_scope/tasks/036-account-router-auth-invalid-exclusion.md`](operational_scope/tasks/036-account-router-auth-invalid-exclusion.md:26)
- Proposed fix:
...
- Уточнить [`operational_scope/tasks/035-openai-chatgpt-auth-invalid-state.md`](operational_scope/tasks/035-openai-chatgpt-auth-invalid-state.md:1): auth-health должен быть описан как расширение canonical envelope [`account_state.json`](docs/contracts/state/account-state.schema.json:1), а не как расплывчатый «отдельный state».
- Уточнить [`operational_scope/tasks/036-account-router-auth-invalid-exclusion.md`](operational_scope/tasks/036-account-router-auth-invalid-exclusion.md:1): добавить явную зависимость от freeze error semantics и snapshot decision.
- Уточнить [`operational_scope/tasks/037-openai-chatgpt-parity-regression-and-doc-sync.md`](operational_scope/tasks/037-openai-chatgpt-parity-regression-and-doc-sync.md:1): добавить sync для state/rotation suites и schema contracts.
