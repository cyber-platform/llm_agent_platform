...
| Admin monitoring boundary | Monitoring state model, provider-specific monitoring contracts | provider-specific monitoring state under [`llm_agent_platform/services/`](llm_agent_platform/services:1) | [`docs/architecture/admin-monitoring-read-model.md`](docs/architecture/admin-monitoring-read-model.md:1), [`docs/adr/0021-account-centric-provider-monitoring-and-admin-read-model.md`](docs/adr/0021-account-centric-provider-monitoring-and-admin-read-model.md:1) | planned suite [`docs/testing/suites/admin-monitoring-read-model.md`](docs/testing/suites/admin-monitoring-read-model.md:1) |
...
### Если меняется provider-specific behavior

- Start: provider page in [`docs/providers/`](docs/providers:1)
- Then: [`docs/architecture/package-map.md`](docs/architecture/package-map.md:1)
...
- Если capability уже канонизирована в `docs/`, но runtime package еще не materialized полностью, это должно быть видно через provider page, architecture note или planned test suite.
