...
| Provider integrations | [`llm_agent_platform/api/openai/providers/`](../../llm_agent_platform/api/openai/providers) | `provider implementation`, upstream protocol adaptation and normalization | [`../providers/README.md`](../providers/README.md) |
...
| Provider registry and catalogs | [`llm_agent_platform/services/provider_registry.py`](../../llm_agent_platform/services/provider_registry.py), [`llm_agent_platform/provider_registry/`](../../llm_agent_platform/provider_registry) | `abstract provider` descriptor loading, catalog resolution | [`../providers/README.md`](../providers/README.md) |
