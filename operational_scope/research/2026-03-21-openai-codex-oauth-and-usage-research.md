...
- Historical note: legacy foundation contract для usage limits был заменён каноническими contracts [`docs/contracts/state/openai-chatgpt-usage-windows.schema.json`](docs/contracts/state/openai-chatgpt-usage-windows.schema.json:1) и [`docs/contracts/state/openai-chatgpt-request-usage.schema.json`](docs/contracts/state/openai-chatgpt-request-usage.schema.json:1)
...
Historical note: ранний generic contract для usage limits был заменён более конкретной канонической формой через `usage_windows.json` и `request_usage.json`.
...
Это исторически привело к current canonical contracts [`docs/contracts/state/openai-chatgpt-usage-windows.schema.json`](docs/contracts/state/openai-chatgpt-usage-windows.schema.json:1) и [`docs/contracts/state/openai-chatgpt-request-usage.schema.json`](docs/contracts/state/openai-chatgpt-request-usage.schema.json:1).
